...
describe('banking_application', () => {
    ...
    it('should have the testID attribute on TextInput to be app-input', () => {
      expect(input).toBeInTheDocument();
    })

    it('should have the testID attribute on Filter button to be submit-button', () => {
      expect(submitButton).toBeInTheDocument();
    })

    it('should have the testID attribute on the Amount table header to be amount', () => {
      expect(amountHeader).toBeInTheDocument();
    })

    it('should have the testID attribute on the table body container TableBody to be records-body', () => {
      expect(recordsBody).toBeInTheDocument();
    })
